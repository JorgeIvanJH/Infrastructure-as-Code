...
| [05 - SPE monitoring, desktop, and data tools](05-spe-monitoring-agent-gcp/) | Reach an SPE through Guacamole, then read a shared CSV with JupyterLab and RStudio. |
